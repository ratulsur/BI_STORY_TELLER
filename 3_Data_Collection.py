    ...
    with col2:
        if st.button("Generate Sample Data", help="Create sample responses for demonstration"):
            with st.spinner("Generating sample data..."):
                if hasattr(st.session_state, 'sheets_client') and st.session_state.sheets_client:
                    ...
                    st.error("Sheets client not available")
...
1. **Approve & Deploy**: Activate questionnaire for collection
2. **Interactive Form**: Fill out directly in platform
3. **Sample Data**: Generate test responses instantly
4. **Download**: Export collected data

**Sample Data Features:**
- Contextual responses based on questions
